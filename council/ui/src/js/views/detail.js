    ...
    return D.frag([
      ...
      el('div', { class: 'sheet' }, [
        ...
        section('Keeping and reusing', [
          ...
          'A round still running when the panel closed, the plugin stopped or Minerva exited '
            + 'is NOT picked up again: the process that owned those model calls is gone. It '
            + 'comes back as a failed round marked interrupted, with an explicit Retry, so '
            + 'nothing spends on its own and nothing is quietly lost.',
