...
VERSION=8.30.1
CACHE="${PLUGINS_DEPENDENCY_CACHE:-$ROOT/.dependency-cache}/gitleaks-$VERSION"
...
report="$(mktemp "${TMPDIR:-/tmp}/plugins-gitleaks.XXXXXX")"
output="$(mktemp "${TMPDIR:-/tmp}/plugins-gitleaks.XXXXXX.log")"
