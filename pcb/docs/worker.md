...
| _(not exposed yet)_ | `order_package` | the whole order package — gerber archive + both CSVs + assembly preview + checklist + preflight + manifest, from ONE compilation, written atomically. See `docs/order-package.md` |
