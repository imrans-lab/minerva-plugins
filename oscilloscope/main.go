...
func main() {
	...
	for scanner.Scan() {
		...
		switch r.Method {
		case "initialize":
			result = map[string]any{"protocolVersion": "2024-11-05", "capabilities": map[string]any{"tools": map[string]any{}}, "serverInfo": map[string]string{"name": "oscilloscope", "version": "0.1.2"}}
		case "ping":
