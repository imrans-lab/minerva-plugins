...
extends Camera3D
# class_name intentionally omitted: gen3d plugin prefix rule requires Gen3d_
# prefix on all declared class_names. This helper is preloaded by path in
# Gen3dPanel.gd — no class_name registration needed.
